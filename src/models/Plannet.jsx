...
const Plannet = ({ isRotating, setIsRotating, setCurrentStage, ...props }) => {
  ...
  const handlePointerMove = (e) => {
    ...
    if (isRotating) {
      ...
      plannetRef.current.rotation.y += delta * 0.01 * Math.PI;
  ...
  const handleKeyDown = (e) => {
    if (e.key === "ArrowLeft") {
      ...
      plannetRef.current.rotation.y += 0.01 * Math.PI;
  ...
  useFrame(() => {
    if (!isRotating) {
      ...
      plannetRef.current.rotation.y += rotationSpeed.current;
    } else {
      const rotation = plannetRef.current.rotation.y;
